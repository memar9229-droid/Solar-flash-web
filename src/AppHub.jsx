      ...
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        @media(max-width:768px){
          .ap-detail-grid{grid-template-columns:1fr!important;}
          .ap-nav-links{display:none!important;}
          .ap-footer-links{gap:1rem!important;}
        }
        @media(max-width:480px){
          .ap-footer-links{flex-direction:column!important;align-items:center!important;}
        }
