...
export default function OpportunityScanner(){
  ...
  const sendToAlpha=useCallback((opp)=>{
    sessionStorage.setItem("sf_alpha_opp",JSON.stringify({
      ...opp,
      mint: opp.mint || null,
    }));
