...
function DetailPanel({opp,onClose,onSendToAlpha}){
  ...
  return(
    <div style={{position:"fixed",inset:0,zIndex:1000,display:"flex"}}>
      ...
      <div style={{width:"clamp(340px,42vw,520px)",height:"100vh",background:"#060402",borderLeft:`1px solid ${col}28`,overflowY:"auto",display:"flex",flexDirection:"column",animation:"dp-slide .3s ease"}}>
