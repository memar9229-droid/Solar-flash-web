      ...
      <div style={{position:"relative",zIndex:10,maxWidth:"1300px",margin:"0 auto",padding:"clamp(1.5rem,4vw,2.5rem) clamp(1rem,4vw,2rem)"}}>
        ...
        <div style={{display:"flex",gap:"1.2rem",alignItems:"flex-start"}}>
          ...
          <div style={{width:"260px",flexShrink:0,display:"flex",flexDirection:"column",gap:"1rem"}}>
            ...
            {/* Telegram CTA */}
            <div style={{padding:"1.2rem",borderRadius:"12px",border:"1px solid rgba(255,140,0,.2)",background:"linear-gradient(135deg,rgba(255,80,0,.07),rgba(0,0,0,.5))",backdropFilter:"blur(8px)",textAlign:"center"}}>
