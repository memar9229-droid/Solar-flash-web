...
function StrategyPanel({ signal, opp }) {
  return (
    <div style={{ padding:"1.2rem 1.4rem", borderRadius:"14px", border:"1px solid rgba(176,96,255,.3)", background:"rgba(176,96,255,.06)", backdropFilter:"blur(8px)", marginBottom:"1.2rem" }}>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(min(100%,150px),1fr))", gap:".8rem" }}>
        {[
  ...
  return (
    <div style={{ marginBottom:"1.2rem" }}>
      ...
      <div style={{ padding:"1.1rem 1.3rem", borderRadius:"12px", border:"1px solid rgba(255,255,255,.08)", background:"rgba(0,0,0,.45)", backdropFilter:"blur(8px)", animation:"ae-fade .25s ease" }}>
        {tab !== "similar" ? (
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(min(100%,180px),1fr))", gap:".7rem" }}>
            {(tabData[tab]||[]).map((d,i)=>(
...
function ActionBar({ opp, tracked, onTrack }) {
  ...
  return (
    <div style={{ display:"flex", gap:".7rem", flexWrap:"wrap", padding:"1.2rem 1.4rem", borderRadius:"14px", border:"1px solid rgba(255,255,255,.08)", background:"rgba(0,0,0,.45)", backdropFilter:"blur(8px)" }}>
    ...
    <div style={{ minHeight:"100vh", background:T.black, color:"#fff", fontFamily:T.font, overflowX:"hidden", position:"relative", isolation:"isolate" }}>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        @media(max-width:1000px){.ae-main{grid-template-columns:1fr!important;}}
        @media(max-width:600px) {.ae-reason-why{display:none!important;}}
      `}</style>
