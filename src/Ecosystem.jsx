...
const LAYERS = [
  {
    ...
    modules: [
      ...
      { id:"score",      name:"Survival Score",   icon:"🛡", desc:"Token safety scoring engine. Risk detection for any Solana asset.", status:"LIVE", href:"/score",     color:C.ok      },
  ...
  },
  {
    ...
    modules: [
      ...
      { id:"threat",   name:"Threat Scanner",      icon:"☠️", desc:"Automated rug detection, honeypot analysis, and contract risk classification.", status:"NEXT",     href:"/threat", color:C.danger },
    ],
  },
  {
    id: "future",
