...
const LAYERS = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id:"opp",      name:"Opportunity Scanner",  icon:"🔍", desc:"Multi-signal opportunity engine: RSI, MACD, volume, smart money, Survival Score combined.", status:"NEXT",     href:null, color:C.cyan   },
