...
const LAYERS = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id:"smart",    name:"Smart Money Intelligence",icon:"🧠", desc:"Track historically profitable wallets. Follow smart money accumulation before the market moves.", status:"BUILDING", href:null, color:C.purple },
...
export default function Ecosystem() {
  return (
    <div style={{ minHeight:"100vh", background:C.black, color:"#fff", fontFamily:C.font, overflowX:"hidden", position:"relative", isolation:"isolate" }}>
      <style>{`
