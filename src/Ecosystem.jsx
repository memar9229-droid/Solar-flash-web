...
const LAYERS = [
  ...
  },
  {
    ...
    color: C.cyan,
    modules: [
      { id:"narrative",name:"Narrative Radar",       icon:"📡", desc:"AI-powered trend detection across monitored channels. Spot narrative shifts before they go mainstream.", status:"LIVE", href:"/narrative", color:C.orange },
      { id:"smart",    name:"Smart Money Intelligence",icon:"🧠", desc:"Track where sophisticated capital moves. Accumulation patterns, cluster intelligence, capital rotation.", status:"LIVE", href:"/smart-money", color:C.purple },
      { id:"opp",      name:"Opportunity Scanner",  icon:"🔍", desc:"The discovery layer. Combines all intelligence sources to surface opportunities before they become obvious.", status:"LIVE", href:"/scanner", color:C.cyan   },
      { id:"threat",   name:"Threat Scanner",       icon:"☠️", desc:"Advanced rug detection, honeypot analysis and contract risk classification.", status:"NEXT",     href:"/threat", color:C.danger },
    ],
  },
  {
    id: "future",
