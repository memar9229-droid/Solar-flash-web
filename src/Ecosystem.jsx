...
const LAYERS = [
  ...
  },
  {
    ...
    color: C.cyan,
    modules: [
      { id:"narrative",name:"Narrative Radar",       icon:"📡", desc:"AI-powered trend detection across monitored channels. Spot narrative shifts before they go mainstream.", status:"BUILDING", href:null, color:C.orange },
